...
public class ColTransCipher {
    ...
    private static void encryption(){
        ...
        String plainText = in.nextLine().replace(" ", "");
        ...
        System.out.println("ExtraLetters: "+extraLetters);
        int dummyCharacters = keyword.length() - extraLetters;
        System.out.println("DummyCharacters: "+dummyCharacters);
        ...
        for (int i = 0, k = 0; i < kywrdNumList.length; i++, k++) {
            int d;
            if (k == keyword.length()){
                break;
            } else {
    ...
    private static void decryption(){
        ...
        System.out.print("Enter Message: ");
        String msg = in.nextLine().replace(" ", "");
